...
class TreeSetCollection {
    ...
    Comparator<Citizens> citizensComparator = new CitizenNameComporator().thenComparing(new CitizenAgeComporator());
    TreeSet<Citizens> types = new TreeSet<>(citizensComparator);
